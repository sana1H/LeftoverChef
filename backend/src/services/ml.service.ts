...
const ML_API_URL = process.env.ML_API_URL || 'https://mock-ml-api.example.com/predict';
const ML_API_TIMEOUT = 30000;
...
export const processImagePrediction = async (
  ...
  try {
    ...
    if (stats.size > MAX_FILE_SIZE) {
      throw new Error(`File size exceeds maximum limit of ${process.env.MAX_FILE_SIZE_MB}MB`);
    }
